    ...
    <>
      ...
      <Box bg={"secondary"} width={"100%"} alignItems="center" gap={"header"}>
        <Box py={["xl", "header"]} gap={"header"} alignItems={"center"}>
          <Box flexDirection={["column-reverse","row"]} alignItems={"center"} gap={"l"}>
            <Image
            ...
            />
            <Column alignItems={"flex-start"} width={"400px"} px={"xl"} gap={"s"} border= {"3px solid red"}
            >
          ...
          <CenterBox width={["373px","780px"]} bg={"secondary"} color="white"  flexDirection={"column"} textAlign={["start","center"]} px={"s"}>
